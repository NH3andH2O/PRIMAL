...
#define __pyx_kp_u_No_Solution __pyx_string_tab[1]
#define __pyx_kp_u_Out_of_Time __pyx_string_tab[2]
#define __pyx_kp_u__2 __pyx_string_tab[3]
#define __pyx_kp_u_cython_od_mstar_pyx __pyx_string_tab[4]
#define __pyx_n_u_NoSolutionError __pyx_string_tab[5]
#define __pyx_n_u_OutOfTimeError __pyx_string_tab[6]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[7]
#define __pyx_n_u_RLIMIT_AS __pyx_string_tab[8]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[9]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[10]
#define __pyx_n_u_cpp_mstar __pyx_string_tab[11]
 ...
 *         __Pyx_PyList_SET_ITEM(o, i, item)
*/
    __pyx_t_2 = __pyx_convert_vector_to_py_std_3a__3a_pair_3c_int_2c_int_3e___((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 91, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_XDECREF_SET(__pyx_v_item, __pyx_t_2);
    __pyx_t_2 = 0;
 ...
 *     return v
*/
    __pyx_t_6 = __pyx_convert_pair_from_py_int__and_int(__pyx_v_item); if (unlikely(PyErr_Occurred())) __PYX_ERR(1, 61, __pyx_L1_error)
    try {
      __pyx_v_v.push_back(((std::pair<int,int> )__pyx_t_6));
    } catch(...) {
      __Pyx_CppExn2PyErr();
...
static PyMethodDef __pyx_mdef_9cpp_mstar_1find_path = {"find_path", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9cpp_mstar_1find_path, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_9cpp_mstar_find_path};
static PyObject *__pyx_pw_9cpp_mstar_1find_path(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_world,&__pyx_mstate_global->__pyx_n_u_init_pos,&__pyx_mstate_global->__pyx_n_u_goals,&__pyx_mstate_global->__pyx_n_u_inflation,&__pyx_mstate_global->__pyx_n_u_time_limit,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "find_path", 0) < (0)) __PYX_ERR(0, 16, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 5; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("find_path", 1, 5, 5, i); __PYX_ERR(0, 16, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("find_path", 1, 5, 5, __pyx_nargs); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L6_skip:;
...
*/
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_resource, __pyx_mstate_global->__pyx_n_u_RLIMIT_AS); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 37, __pyx_L1_error)
...
__Pyx_RefNannySetupContext("PyInit_cpp_mstar", 0);
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_OutOfTimeError,__pyx_mstate_global->__pyx_n_u_NoSolutionError};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_od_mstar3_col_set_addition, __pyx_imported_names, 2, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9cpp_mstar_1find_path, 0, __pyx_mstate_global->__pyx_n_u_find_path, NULL, __pyx_mstate_global->__pyx_n_u_cpp_mstar, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_find_path, __pyx_t_2) < (0)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
